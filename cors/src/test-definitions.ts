...
export const testDefinitions: TestDefinition[] = [
  ...
  },
  {
    ...
    notes:
      "This shows even with CORS disabled the same origin can still use the endpoint.",
...
<code>method: 'PUT'</code>`,
    notes:
      "Non simple requests require a pre-flight (<code>OPTIONS</code>) request - <code>method</code>.",
...
Custom headers`,
    notes:
      "Non simple requests require a pre-flight (<code>OPTIONS</code>) request - custom headers.",
    requestOptions: {
      headers: {
...
<code>method: 'PUT'</code>`,
    notes:
      "Non simple requests cannot be made with <code>mode: no-cors</code>.",
    requestOptions: {
      method: "PUT",
      mode: "no-cors",
    },
...
the request is even sent, even for an endpoint that would support cross-origin requests for that origin.`,
    url: "${server2}/cors-all-allowed-endpoint",
    requestOptions: { mode: "same-origin" },
    expectNoResponseBody: true,
    expectBlockedRequest: true,
