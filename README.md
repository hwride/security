...
1. [Cross-Site Request Forgery (CSRF)](csrf): Some CSRF testing.
1. [HTTPS certificates and local Node.js HTTPS testing](https)
...
1. [HTTP proxy experiments](proxy): a small HTTP reverse proxy written in Node.
